...
import 'package:food_delivery_app1/views/widgets/counter_widget.dart';
import 'package:food_delivery_app1/views/widgets/product_specs_item.dart';
    ...
    return Scaffold(
      appBar: AppBar(
        ...
        actions: [
          IconButton(
            onPressed: () {
              setState(() {//the logic of the favPage. 
